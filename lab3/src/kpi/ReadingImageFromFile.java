...
public class ReadingImageFromFile {
    ...
    // метод для читання файлу з зображенням та виведення інформації про зчитаний файл, який приймає на вхід назву файлу з зображенням у форматі BMP
    ...
    public static void loadBitmapImage(String filename) throws IOException {
        ...
        // потік для запису зчитаних зображень про пікселі у ASCII кодах
        BufferedOutputStream writer = new BufferedOutputStream (new FileOutputStream("primer_bmp.txt"));
